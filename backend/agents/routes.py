...
ROUTES: dict[tuple[str, str], dict[str, Any]] = {
    ...
    ("china", "vietnam"): {
        "overland": "Nanning - Hanoi bus via the Huu Nghi/Youyi Guan border, 6-8h, USD 25-35. A slower international train also runs this route.",
        "overland_hours": 7,
        "overland_cost_usd": 30,
        "flight": "Guangzhou or Nanning - Hanoi, 1.5h, USD 80-150.",
        "flight_hours": 1.5,
        "flight_cost_usd": 110,
        "border_notes": "Straightforward land border, one of the more heavily used China-SE Asia crossings. Vietnam's own visa rules still apply on arrival.",
    },
    ("china", "laos"): {
        "overland": "Kunming - Vientiane on the China-Laos high-speed railway, roughly 10-13h including border formalities, USD 40-70 in economy class.",
        "overland_hours": 11,
        "overland_cost_usd": 55,
        "flight": "Kunming - Vientiane, 1.5h, USD 100-180.",
        "flight_hours": 1.5,
        "flight_cost_usd": 140,
        "border_notes": "The railway (opened 2021) has made this the most practical overland China-SE Asia crossing; book ahead in peak season, seats sell out.",
    },
    ("china", "mongolia"): {
        "overland": "Beijing - Ulaanbaatar on the Trans-Mongolian train (K23/K3), roughly 27-30h, USD 150-300 depending on class - the classic backpacker rail journey between the two, running only a few times a week.",
        "overland_hours": 28,
        "overland_cost_usd": 220,
        "flight": "Beijing - Ulaanbaatar, 2.5h, USD 200-350 - historically limited and pricey for the distance.",
        "flight_hours": 2.5,
        "flight_cost_usd": 275,
        "border_notes": "Book the train well ahead - departures are infrequent and sell out in Mongolia's short summer season.",
    },
    ("china", "nepal"): {
        "overland": "Technically possible via the Tibet Autonomous Region, but NOT independently: the same agency-arranged permit, guide and vehicle required for any Tibet travel applies to this crossing, so it is not a real budget-backpacker option.",
        "overland_hours": None,
        "overland_cost_usd": None,
        "flight": "Kathmandu - Chengdu or Chongqing, 3.5h, USD 250-400 (a direct Kathmandu-Lhasa flight exists but still requires the Tibet permit to use).",
        "flight_hours": 3.5,
        "flight_cost_usd": 320,
        "border_notes": "Flying is the only practical independent option; the land route is a Tibet tour, not a border crossing.",
    },
    ("china", "myanmar"): {
        "overland": "A land border exists at Ruili-Muse, but independent foreign travel across it is unreliable and often restricted given conflict in Myanmar's border regions - check current conditions immediately before planning this, not just before travelling.",
        "overland_hours": None,
        "overland_cost_usd": None,
        "flight": "Kunming - Mandalay or Yangon, 2h, USD 150-250.",
        "flight_hours": 2.0,
        "flight_cost_usd": 200,
        "border_notes": "Flying is the standard advice; see Myanmar's own visa document for the wider safety caveat.",
    },
    ("china", "japan"): {
        "overland": "No land route. A Shanghai - Osaka ferry runs roughly twice weekly, about 45h, from around USD 150-200 for the cheapest berth - a genuine slow, cheap alternative for anyone not in a hurry.",
        "overland_hours": 45,
        "overland_cost_usd": 175,
        "flight": "Shanghai or Beijing - Tokyo or Osaka, 3-3.5h, USD 150-350.",
        "flight_hours": 3.25,
        "flight_cost_usd": 250,
        "border_notes": "Flying is far more common than the ferry; book the ferry well ahead as sailings are infrequent.",
    },
    ("china", "south korea"): {
        "overland": "No land route. Overnight ferries run Qingdao or Tianjin - Incheon, roughly 16-24h, USD 80-150 - a real budget option, especially for anyone already in northern China.",
        "overland_hours": 20,
        "overland_cost_usd": 110,
        "flight": "Beijing or Shanghai - Seoul, 2h, USD 150-300.",
        "flight_hours": 2.0,
        "flight_cost_usd": 220,
        "border_notes": "The ferry is genuinely used by backpackers and students, not just cargo - book through a local travel agent or the ferry operator's site rather than assuming it's bookable like a flight.",
    },
}
